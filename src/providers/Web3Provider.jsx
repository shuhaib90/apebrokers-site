...
// Define Robinhood Chain (ID 4663 / 0x1237)
...
// Also support legacy/alternative chain ID 4689
export const robinhoodChainAlt = {
  id: 4689,
  name: 'Robinhood EVM',
  nativeCurrency: { name: 'Ether', symbol: 'ETH', decimals: 18 },
  rpcUrls: {
...
export const config = getDefaultConfig({
  ...
  chains: [robinhoodChain, robinhoodChainAlt, hardhat, mainnet, base, arbitrum, polygon],
  transports: {
